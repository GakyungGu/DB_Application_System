...
<%
	...
	<tr><br>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">과목 이름</h2></div></td>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">분반</h2></div></td>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">요일</h2></div></td>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">시간</h2></div></td>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">장소</h2></div></td>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">인원</h2></div></td>
	<td><div align="center"><h2 style="background-color: #FFFFC6; font-size:25px;">학점</h2></div></td>
